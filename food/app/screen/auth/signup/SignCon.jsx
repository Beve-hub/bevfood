...
const SignCon = () => {
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        ...
        <TouchableOpacity onPress={() => router.push('../signup/SignForm')} style={{height: hp(6), justifyContent: 'center', borderRadius: 10, display: 'absolute', alignItems: 'center', backgroundColor: "#B40404",}} >
